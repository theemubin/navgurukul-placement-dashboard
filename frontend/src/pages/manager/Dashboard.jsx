    ...
    return (
      <div className="space-y-6 animate-pulse">
        ...
        <div className="card h-48 flex items-center justify-center">
          <div className="w-2/3 h-full py-6 space-y-3">
        ...
        {/* Coordinator Table Skeleton */}
        <div className="card space-y-4">
          <div className="h-5 w-52 bg-gray-200 rounded-md" />
          <div className="space-y-3">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="grid grid-cols-4 gap-4 p-3 bg-gray-50 rounded-lg">
