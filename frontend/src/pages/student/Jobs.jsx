            ...
            {[...Array(4)].map((_, i) => (
              <div key={i} className="bg-white rounded-[1.5rem] border border-gray-100 p-5 md:p-6 space-y-4">
                <div className="flex flex-col md:flex-row md:items-start gap-6">
                  {/* Logo Placeholder */}
                  <div className="w-16 h-16 rounded-2xl bg-gray-200 shrink-0 mx-auto md:mx-0" />
                  ...
                  <div className="flex-1 space-y-3 min-w-0">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-2">
                      {[...Array(4)].map((_, j) => (
                        <div key={j} className="flex items-center gap-2">
                          ...
                          <div className="h-4.5 w-20 bg-gray-250 rounded" />
                        </div>
                      ))}
                    </div>
                    ...
                    <div className="flex flex-wrap gap-2 pt-2">
                      {[...Array(3)].map((_, j) => (
                        <div key={j} className="h-6 w-16 bg-gray-100 rounded-lg" />
                      ))}
                    </div>
                  </div>

                  {/* Action Column Placeholder */}
                  <div className="flex md:flex-col items-center justify-between md:justify-center gap-4 shrink-0 border-t md:border-t-0 md:border-l border-gray-100 pt-4 md:pt-0 md:pl-6 w-full md:w-auto">
                    <div className="flex flex-col items-end gap-2">
                      <div className="h-6 w-20 bg-gray-200 rounded-full" />
                      <div className="h-8 w-16 bg-gray-300 rounded mt-1" />
                    </div>
