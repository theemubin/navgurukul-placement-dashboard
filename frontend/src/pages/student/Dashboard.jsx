      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-[2rem] border border-gray-100 p-8 shadow-xl shadow-gray-100/50">
              ...
              <div className="space-y-4">
                ...
                <div className="h-4 bg-gray-50 rounded-full overflow-hidden border border-gray-100 p-0.5">
                  <div
                    className={`h-full rounded-full transition-all duration-1000 ease-out shadow-sm ${jobReadiness.progress.isJobReady ? 'bg-gradient-to-r from-green-500 to-emerald-600' : 'bg-gradient-to-r from-primary-500 to-primary-700'
                      }`}
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <Link to="/student/applications" className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow group block">
            ...
            <Link to="/student/applications?filter=In%20Process" className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow group block">
            ...
            <Link to="/student/applications?filter=Selected" className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow group block">
            ...
            <Link to="/student/applications?filter=Rejected" className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow group block">
              ...
              {recentApplications.length > 0 ? (
                <div className="grid grid-cols-1 gap-3">
                  {recentApplications.map((app) => (
                    <Link
                      key={app._id}
                      to={`/student/applications?appId=${app._id}`}
                      className="flex items-center justify-between p-4 rounded-2xl bg-gray-50/50 hover:bg-white hover:shadow-lg hover:shadow-gray-200/50 border border-transparent hover:border-gray-100 transition-all group cursor-pointer"
                    >
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <ArrowRight size={14} className="text-gray-300 group-hover:text-primary-500 group-hover:translate-x-1 transition-all shrink-0" />
                      </div>
                    </Link>
                  ))}
                </div>
